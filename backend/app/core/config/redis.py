...
from app.workflows.builder import build_graph_from_definition  # your existing graph builder
    ...
    async def get(self, workflow_id: str, version: Optional[str] = None) -> Optional[CompiledStateGraph]:
        ...
        try:
            ...
            if cached_data:
                ...
                compiled = await build_graph_from_definition(workflow_id, version)
